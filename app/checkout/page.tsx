...
class PayPalErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  public render() {
    if (this.state.hasError) {
      return (
        <div style={{ padding: '18px', background: '#fff9e6', border: '1px solid #fae69e', borderRadius: '8px', color: '#8a6400', fontSize: '13.5px', textAlign: 'center' }}>
          <p style={{ margin: '0 0 8px', fontWeight: 700 }}>⚠️ Bank Gateway Initialization Notice</p>
          <p style={{ margin: 0 }}>
            Connecting to international bank network. Please refresh the page or ensure you have a stable internet connection.
          </p>
        </div>
      );
    }
            ...
            <div className="section-card">
              ...
              <div style={{ background: '#fbfaf8', border: '1px solid #eae7e1', borderRadius: '8px', padding: '14px 16px', marginBottom: '20px' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '6px' }}>
                  <span style={{ fontSize: '13px', fontWeight: 700, color: '#333' }}>Accepted Global Payment Methods:</span>
                ...
                <p style={{ margin: 0, fontSize: '12.5px', color: '#666', lineHeight: 1.5 }}>
                  Payments are authenticated directly by your card-issuing bank via 256-Bit SSL encryption. Funds are securely transferred in real time.
                </p>
              </div>
