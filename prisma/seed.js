...
async function main() {
  ...
  const faqs = [
    ...
    { question: 'How long does international shipping take?', answer: 'Standard insured shipping takes 7 to 14 business days internationally. Express DHL/FedEx (3 to 5 days) is available at an additional charge. All shipments are fully insured and tracked.' },
