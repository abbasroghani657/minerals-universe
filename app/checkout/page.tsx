...
import { Lock, Package, FileCheck, ShieldCheck, CreditCard, Globe } from 'lucide-react';
import { formatPrice, convertPrice, getCurrencyCode, getCurrencySymbol, getExchangeRate } from '@/utils/price';

// Dynamically import PayPal section on client only to guarantee 0 SSR crashes
const PayPalCheckoutSection = dynamic(() => import('@/components/PayPalCheckoutSection'), {
  ...
  loading: () => (
    <div style={{ padding: '24px', textAlign: 'center', background: '#faf9f6', borderRadius: '8px', color: '#777', fontSize: '14px' }}>
      🔒 Loading 256-Bit SSL Bank Payment Gateway...
    </div>
  ),
});
...
export default function PremiumCheckoutPage() {
  ...
  const handleApproveOrder = async (txnId: string) => {
        ...
        <div className="checkout-container">
          ...
          <div>
            ...
            <div className="section-card">
              ...
              {/* Dynamic Client-Only PayPal & Card Stack */}
